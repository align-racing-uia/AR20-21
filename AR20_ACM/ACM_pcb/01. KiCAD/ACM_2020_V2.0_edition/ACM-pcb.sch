...
CAN_CS
Text HLabel 9300 5600 0    50   Input ~ 0
CAN_CS
Text HLabel 9300 5400 0    50   Input ~ 0
MOSI
Text HLabel 9300 5500 0    50   Input ~ 0
MISO
...
U 1 1 5D3B887F
P 10450 4100
F 0 "R7" H 10520 4146 50  0000 L CNN
F 1 "120 Ohm" H 10520 4055 50  0000 L CNN
...
U 1 1 5D3C238E
P 10375 6200
F 0 "#PWR027" H 10375 5950 50  0001 C CNN
...
U-Pin1
Text HLabel 10625 3950 2    50   Input ~ 0
U-Pin27
...
F 1 "R-Device-ACM_Y2020V0.1-rescue" V 8409 1300 50  0000 C CNN
...
$EndComp
Wire Wire Line
	10450 3950 10625 3950
Connection ~ 10450 3950
Wire Wire Line
	10325 4250 10450 4250
Wire Wire Line
...
U 1 1 5F756410
P 9900 5700
F 0 "U4" H 10450 6475 50  0000 C CNN
F 1 "MCP2517FD-xSL" H 10425 6325 50  0000 C CNN
F 2 "ACM_2020_V2:Can_MCP2517FD_SOIC" H 9900 4700 50  0001 C CNN
F 3 "https://ww1.microchip.com/downloads/en/DeviceDoc/20005688A.pdf" H 9900 5950 50  0001 C CNN
	1    9900 5700
	1    0    0    -1  
$EndComp
Wire Wire Line
	10050 4150 10325 4150
Wire Wire Line
	10325 4150 10325 4250
Wire Wire Line
...
U 1 1 5F7AF916
P 9300 3400
F 0 "C6" V 9048 3400 50  0000 C CNN
F 1 "0.1uF" V 9139 3400 50  0000 C CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 9338 3250 50  0001 C CNN
...
U 1 1 5F7AF921
P 9150 3400
F 0 "#PWR0113" H 9150 3150 50  0001 C CNN
...
$EndComp
$Comp
L ACM-pcb-rescue:MCP2542WFDxMF U2
U 1 1 5F77486A
P 9550 4050
F 0 "U2" H 9550 3561 50  0000 C CNN
F 1 "MCP2542WFDxMF" H 9550 3470 50  0000 C CNN
F 2 "Package_DFN_QFN:DFN-8-1EP_3x3mm_P0.65mm_EP1.55x2.4mm" H 9550 3550 50  0001 C CIN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/MCP2542FD-4FD-MCP2542WFD-4WFD-Data-Sheet20005514B.pdf" H 9550 4050 50  0001 C CNN
	1    9550 4050
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F8944CC
P 9575 5125
F 0 "C7" V 9323 5125 50  0000 C CNN
F 1 "0.1uF" V 9414 5125 50  0000 C CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 9613 4975 50  0001 C CNN
...
U 1 1 5F8944D2
P 9425 5125
F 0 "#PWR015" H 9425 4875 50  0001 C CNN
F 1 "GND" H 9430 4952 50  0000 C CNN
F 2 "" H 9425 5125 50  0001 C CNN
...
U 1 1 5F8944D8
P 9900 5100
F 0 "#PWR016" H 9900 4950 50  0001 C CNN
...
U 1 1 5F8A0EC5
P 9700 3400
F 0 "C8" V 9448 3400 50  0000 C CNN
F 1 "0.1uF" V 9539 3400 50  0000 C CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 9738 3250 50  0001 C CNN
...
U 1 1 5F8B59C8
P 9850 3400
F 0 "#PWR0114" H 9850 3150 50  0001 C CNN
